<svg class="wave-top" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <h1 class="text-5xl w-full my-2 font-bold text-center text-white">Call You</h1>
  <div class="w-full mb-4">
          <div class="h-1 mx-auto bg-white w-64 opacity-25 my-0 py-0 rounded-2xl"> </div>
        </div>
        <h4 class="my-4 text-3xl"><?php echo get_theme_mod('phone'); ?></h4>
...
<footer class="bg-slate-900 py-7 text-white shadow-2xl shadow-white">
    <div class="container mx-auto flex flex-wrap justify-between">
        ...
        <?php 
            ...
            {
                echo '<img class="w-30 h-11" src="'.get_template_directory_uri(). '/assets/img/osa-logo.svg'.'" />';
            }
