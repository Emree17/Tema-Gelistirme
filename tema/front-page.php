    ...
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <a href="<?php echo get_theme_mod('button_link')?>">   
         ...
         <div class="w-full md:w-3/5 py-6 text-center">
            <img class="w-50 h-21 " src="<?php echo get_template_directory_uri(); ?>/assets/img/osa-logo.svg">
         </div>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
              ...
              <div class="w-full sm:w-1/2 p-6">
                <img class="w-72 md:4/5 z-50" src="<?php echo get_template_directory_uri(); ?>/assets/img/osa-logo.svg">
                  </div>
              </div>
