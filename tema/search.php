...
<div class="relative -mt-12 lg:-mt-24 -z-50">
...
if ( have_posts() ) {
	?>
	<header class="bg-white text-2xl text-black text-center">
		<h1 class="bg-white text-2xl text-black text-center">
			<?php
			printf(
	...
	<div class="bg-white text-2xl text-black text-center">
		<?php
		printf(
			esc_html(
    ...
    <div class="container max-w-5xl mx-auto m-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6"><!-- .search-result-count -->
	<?php
	// Start the Loop.
	while(have_posts()) :the_post(); ?>
        ...
        <?php endwhile; }
          ...
          echo '<div class="bg-white h-36 text-2xl text-black text-center"> NO RESULT </div>';
        }?>
